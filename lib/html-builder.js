...
const { buildDownloadButtonsHTML } = require('./config');
...
function generateCoverHTML({ title, slideCssRel, outputDir }) {
  ...
  // generateHTML 과 동일한 ratio 클래스 계산
  let ratioClass = 'ratio-none';
...
<head>
  ...
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/reveal.js@5.0.4/dist/reset.css">
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/reveal.js@5.0.4/dist/reveal.css">
  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/highlight.js@11.9.0/styles/github.css">${openPropsLink}${fontImports}${cssLink}
  <style>
