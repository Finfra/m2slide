...
let STYLE_CONFIG = {
  style: {
    ...
    title: { maxFontSize: '1em', maxFontColor: '#000000', align: 'center', outer_padding: '1%', fontFamily: '' },
    main_title: { maxFontSize: '80px', maxFontColor: '#333333', align: 'center', outer_padding: '40px 0 20px 0', fontFamily: '' },
    outline_title: { maxFontSize: '2.5em', maxFontColor: '#000000', align: 'center', outer_padding: '0', fontFamily: '' },
    outline_title_sub: { maxFontSize: '1em', maxFontColor: '#666666', align: 'right', outer_padding: '5px', fontFamily: '' },
    theContents: {
      maxFontSize: '1em', maxFontColor: '#000000', align: 'left', outer_padding: '5px', fontFamily: '',
          ...
          if (key && val) {
            if (key && val) {
              if (currentSection === 'global') {
                ...
                if (key === 'font_family') STYLE_CONFIG.style.title.fontFamily = val;
              } else if (currentSection === 'main_title') {
                if (key === 'max_font_size') STYLE_CONFIG.style.main_title.maxFontSize = val;
                if (key === 'max_font_color') STYLE_CONFIG.style.main_title.maxFontColor = val;
                ...
                if (key === 'max_font_size') STYLE_CONFIG.style.outline_title.maxFontSize = val;
                if (key === 'max_font_color') STYLE_CONFIG.style.outline_title.maxFontColor = val;
                ...
                if (key === 'font_family') STYLE_CONFIG.style.outline_title.fontFamily = val;
              } else if (currentSection === 'outline_title_sub') {
                if (key === 'max_font_size') STYLE_CONFIG.style.outline_title_sub.maxFontSize = val;
                if (key === 'max_font_color') STYLE_CONFIG.style.outline_title_sub.maxFontColor = val;
                ...
                if (key === 'font_family') STYLE_CONFIG.style.outline_title_sub.fontFamily = val;
...
<head>
  ...
  <style>
    ...
    #toc-container h1.main-title {
      ...
      font-size: var(--main-title-max-font-size, 80px);
      margin: 0;
...
<body class="${TOP_ALIGN ? 'top-align-mode' : ''} ${GUID_LINE ? 'guide-line-mode' : ''} media-enlarge-${STYLE_CONFIG.style.theContents.media_container_enlarge || 'original'}" style="
  ...
  --title-font-family: ${STYLE_CONFIG.style.title.fontFamily || 'inherit'};
  ...
  --main-title-max-font-size: ${STYLE_CONFIG.style.main_title.maxFontSize};
  --main-title-color: ${STYLE_CONFIG.style.main_title.maxFontColor};
  --main-title-align: ${STYLE_CONFIG.style.main_title.align};
  --main-title-padding: ${STYLE_CONFIG.style.main_title.outer_padding};
  --outline-title-font-family: ${STYLE_CONFIG.style.outline_title.fontFamily || 'inherit'};
  --outline-title-max-font-size: ${STYLE_CONFIG.style.outline_title.maxFontSize};
  --outline-title-color: ${STYLE_CONFIG.style.outline_title.maxFontColor};
  ...
  --outline-title-sub-font-family: ${STYLE_CONFIG.style.outline_title_sub.fontFamily || 'inherit'};
  --outline-title-sub-max-font-size: ${STYLE_CONFIG.style.outline_title_sub.maxFontSize};
  --outline-title-sub-color: ${STYLE_CONFIG.style.outline_title_sub.maxFontColor};
...
${slidesHTML}
  ...
  <script>
    ...
    Reveal.on('ready', () => {
      ...
      // Observe all slides (or just the active one? All is safer for transitions)
