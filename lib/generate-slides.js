...
let STYLE_CONFIG = {
  style: {
    title: { maxFontSize: '1em', maxFontColor: '#000000', align: 'center', outerpadding: '1%' },
    sub_title: { maxFontSize: '1em', maxFontColor: '#666666', align: 'right', outerpadding: '5px' },
    theContents: {
      maxFontSize: '1em', maxFontColor: '#000000', align: 'left', outerpadding: '5px',
    ...
    if (styleSection) {
      ...
      lines.forEach(line => {
        ...
        if (indent === 2 && content.endsWith(':')) {
          ...
          let [key, val] = content.split(':').map(s => s.trim());
          ...
          if (key && val) {
            if (key && val) {
              if (currentSection === 'title') {
                ...
                if (key === 'outerpadding') STYLE_CONFIG.style.title.outerpadding = val;
                ...
                if (key === 'outerpadding') STYLE_CONFIG.style.sub_title.outerpadding = val;
                ...
                if (key === 'outerpadding') STYLE_CONFIG.style.theContents.outerpadding = val;
...
<body class="${TOP_ALIGN ? 'top-align-mode' : ''} ${GUID_LINE ? 'guide-line-mode' : ''} media-enlarge-${STYLE_CONFIG.style.theContents.media_container_enlarge || 'original'}" style="
  ...
  --title-padding: ${STYLE_CONFIG.style.title.outerpadding};
  ...
  --subtitle-padding: ${STYLE_CONFIG.style.sub_title.outerpadding};
  ...
  --content-padding: ${STYLE_CONFIG.style.theContents.outerpadding};
">
