...
const { parseAgenda, getAgendaTitle, getLastChapter } = require('./agenda');
...
function main() {
  ...
  const agendaHTML = generateAgendaHTML({ projectDir, title: agendaTitle, tocData: agendaTocData, slideCssRel: cfg.slideCssRel, outputDir, lastChapter, mode, coverEnabled: cfg.coverEnabled });
