...
//
// 진행: v1 4타입(cycle·hierarchy·pyramid·process) + Issue202 확장 10타입
//   (timeline·venn·matrix·target·funnel·gear·radial·chevron·step·arrow) = 14타입
//   전부 d3 SVG 렌더. theme `_shared/components.css` 의 타입별 htmlArt CSS 블록은
//   전부 제거됨 (`.m2-htmlart` 공통 컨테이너 — CSS 변수·component-error 만 잔존).
//
// d3 API 사용:
