...
(function(){
  ...
  function renderCycle(el){
    ...
    var svg=d3.select(el).append('svg')
      ...
      .attr('style','width:100%;height:auto;max-height:52vh;display:block;margin:0 auto');
    ...
    svg.append('text')
      ...
      .attr('style','font-size:76px;fill:var(--htmlart-accent,#2b8a9d);opacity:.38')
      .text('\\u21BB');
  ...
  function renderHierarchy(el){
    ...
    var nodeW=152, nodeH=58;
    var tree=d3.tree().nodeSize([nodeW+44, nodeH+78]);
    tree(root);
    ...
    var svg=d3.select(el).append('svg')
      ...
      .attr('style','width:100%;height:auto;max-height:70vh;display:block;margin:0 auto');
  ...
  function renderPyramid(el){
    ...
    var svg=d3.select(el).append('svg')
      ...
      .attr('style','width:100%;height:auto;max-height:74vh;display:block;margin:0 auto');
  ...
  function renderProcess(el){
    ...
    var N=items.length;
    var boxW=224, boxH=120, arrowGap=64, padY=18;
