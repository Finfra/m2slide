...
class DevHandler(SimpleHTTPRequestHandler):
    ...
    _CONFIG_SCHEMA = [
        ...
        {'key': 'cards_placeholder', 'tab': 2, 'type': 'bool', 'label': 'H1 카드 페이지', 'en': 'H1 cards page', 'default': 'false', 'help': 'H1 챕터마다 카드형 섹션 페이지 생성.', 'help_en': 'Generate a card-style section page per H1 chapter.'},
        ...
        {'key': 'toc_card_mode', 'tab': 2, 'type': 'bool', 'label': 'TOC 카드 렌더', 'en': 'TOC card mode', 'default': 'true', 'help': '목차를 카드 그리드로 렌더.', 'help_en': 'Render the TOC as a card grid.'},
        ...
        # Tab 6 — Build & Deploy
        {'key': 'asset_mode', 'tab': 6, 'type': 'enum', 'label': '자산 배치', 'en': 'Asset mode', 'default': 'cdn', 'options': ['vendor', 'cdn'], 'help': '런타임 자산 배치. vendor=로컬 번들(오프라인), cdn=CDN.', 'help_en': 'Runtime asset mode: vendor (local, offline) or cdn.'},
