...
// Kroki 빌드 타임 캐시 디렉토리 (절대 경로). html-builder.js에서 setKrokiCacheDir로 주입.
//   주입 안 되면 캐시 비활성 → URL만 박아두고 런타임에 kroki.io 호출
let _krokiCacheDir = null;
let _krokiCacheRel = 'kroki';   // HTML img src 기준 상대 경로 (slide/kroki/...)
let _krokiServer = 'https://kroki.io';

function setKrokiCacheDir(absDir, relPath, server) {
