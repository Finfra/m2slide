...
```
http://localhost:9877/p/<project>/s/<chap>/<N>             # /s/ = solo (단일 슬라이드 design)
http://localhost:9877/p/<project>/n/<chap>/<N>             # /n/ = deck navigation
http://localhost:9877/p/<project>/n/<chap>/<section-id>    # deck nav + reveal.js id hash
```
